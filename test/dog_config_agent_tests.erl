...
teardown(Context) ->
    %Apps = [sasl,xmerl,jsx,ranch,recon,rabbit_common,amqp_client,hut,setup,bear,folsom,exometer_core,gproc,quickrand,uuid,turtle,base16,fn,erldocker,bbmustache,jsn,dog],
    %Apps = [dog],
