...
-export([from_map/1, to_group_routing_key/1,
     to_host_routing_key/1, to_map/1]).

-export([dog_state/0, dog_state/14, get_environment/1,
     get_group/1, get_hash4_ipsets/1, get_hash4_iptables/1,
     get_hash6_ipsets/1, get_hash6_iptables/1, get_hostkey/1,
     get_hostname/1, get_interfaces/1, get_ipset_hash/1,
     get_location/1, get_provider/1, get_updatetype/1,
     get_version/1, set_environment/2, set_group/2,
     set_hash4_ipsets/2, set_hash4_iptables/2,
     set_hash6_ipsets/2, set_hash6_iptables/2, set_hostkey/2,
     set_hostname/2, set_interfaces/2, set_ipset_hash/2,
     set_location/2, set_provider/2, set_updatetype/2,
     set_version/2]).
